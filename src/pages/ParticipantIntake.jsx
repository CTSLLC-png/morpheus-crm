...
const s = {
  ...
  stepDot: { width: '28px', height: '28px', borderRadius: '50%', background: '#E8EFF6', color: '#5D768A', fontSize: '12px', fontWeight: 600, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, transition: 'all 0.2s' },
